...
public class NewOkCancelDialog extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addComponent(numPlayers, javax.swing.GroupLayout.PREFERRED_SIZE, 181, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(43, 43, 43))
        );
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(numofplayerslabel)
                    .addComponent(numPlayers, javax.swing.GroupLayout.PREFERRED_SIZE, 37, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(100, 100, 100)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(cancelButton)
    ...
    private void okButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_okButtonActionPerformed
        String number = numPlayers.getText();
        
        Connect.createNewTable(); //Empty existing players
        
        if(number != (null)){
            double numbers = Double.parseDouble(number);
            if(numbers < 2 ){
                message.setText("Should not be between 2 and 6");
            }else if(numbers >= 2 && numbers <= 6){
                
                numPlayers.setEditable(false);
                for(int i=0; i<numbers; i++){
                    int x = i +1;
                    String name = JOptionPane.showInputDialog(null, "Player " + x + " Name");
                    Connect.insert(name, 1500);
                }
                doClose(RET_OK);
            }else if (numbers > 6){
                message.setText("Should not be between 2 and 6");
            ...
            message.setText("Should not be empty");
        }
